...
import TopSoldtable from "@/app/ui/Reports/TopSoldtable";
        ...
        <main>
            <Breadcrumbs
                breadcrumbs={[
                    ...
                    {
                        label: 'Top Sold Product Reports',
                        href: '/dashboard/report/topSold',
                        active: true,
                    },
                ]}
            />
            <div className="w-full">
                ...
                <Suspense fallback={<InvoicesTableSkeleton />}>
                    <TopSoldtable region={region} district={district} startDate={startDate} endDate={endDate} user={user} />
                </Suspense>
            </div>
        </main>
