...
import { deleteProductStock } from '@/app/lib/actions'

export function CreateStock() {
  return (
    <Link
      href="/dashboard/ProductStock/create"
...
export function DeleteStock({ id }: { id: string }) {
  ...
  return (
    <form action={deleteProductStockwithId}>
      <button className="rounded-md border p-2 text-red-700">
